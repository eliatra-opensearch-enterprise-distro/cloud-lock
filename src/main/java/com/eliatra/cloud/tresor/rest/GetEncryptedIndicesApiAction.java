...
import com.eliatra.cloud.tresor.plugin.EliatraCloudTresorPluginSettings;
...
public class GetEncryptedIndicesApiAction extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return List.of(new Route(GET, "/_eliatra/cloud_tresor/api/_get_encrypted_indices"));
    }
            ...
            try {
                ...
                Arrays.stream(clusterMetadata.getConcreteAllIndices()).forEach(
                        index -> {
                            ...
                            if(EliatraCloudTresorPluginSettings.INDEX_ENCRYPTION_ENABLED.getFrom(
                ...
                for(IndexMetadata indexMetadata: encryptedIndices) {
                    ...
                    builder.field("store_type_original", EliatraCloudTresorPluginSettings.INDEX_STORETYPE_ORIGINAL.getFrom(indexMetadata.getSettings()));
                    builder.endObject();
                }
                builder.endObject();
